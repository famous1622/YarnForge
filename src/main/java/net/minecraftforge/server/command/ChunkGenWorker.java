        ...
        */
        ...
        if (next != null)
        {
            ...
            if (!world.isChunkLoaded(x, z)) { //Chunk is unloaded
                Chunk chunk = world.getChunk(x, z, ChunkStatus.field_12798, true);
                if (!chunk.getStatus().isAtLeast(ChunkStatus.field_12803)) {
                    chunk = world.getChunk(x, z, ChunkStatus.field_12803);
