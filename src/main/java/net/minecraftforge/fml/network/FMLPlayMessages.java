...
public class FMLPlayMessages
{
    ...
    public static class SpawnEntity
    {
        ...
        {
            this.entity = e;
            this.typeId = Registry.field_11145.getRawId(e.getType());
        ...
        {
            ctx.get().enqueueWork(() -> {
                EntityType<?> type = Registry.field_11145.get(msg.typeId);
                if (type == null)
                {
    ...
    public static class DimensionInfoMessage
    {
        ...
        private DimensionType makeDummyDimensionType() {
            ...
            if (modDim == null) return DimensionType.field_13072;
            modDim.read(extraData, true);
            return new DimensionType(id, "dummy", "dummy", modDim.getFactory(), skylight, VoronoiBiomeAccessType.field_20644, modDim, extraData);
        }
