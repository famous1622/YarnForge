...
public class LoadingErrorScreen extends FatalErrorScreen {
    ...
    public void init()
    {
        ...
        this.errorHeader = Formatting.field_1061 + ForgeI18n.parseMessage("fml.loadingerrorscreen.errorheader", this.modLoadErrors.size()) + Formatting.field_1070;
        this.warningHeader = Formatting.field_1054 + ForgeI18n.parseMessage("fml.loadingerrorscreen.warningheader", this.modLoadErrors.size()) + Formatting.field_1070;
