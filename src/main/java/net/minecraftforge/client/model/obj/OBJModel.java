...
public class OBJModel implements IMultipartModelGeometry<OBJModel>
{
    ...
    private Pair<BakedQuad,Direction> makeQuad(int[][] indices, int tintIndex, Vector4f colorTint, Vector4f ambientColor, Sprite texture, Rotation3 transform)
    {
        ...
        if (detectCullableFaces)
        {
            ...
            {
                cull = Direction.field_11043; // can never remember
            }
            ...
            {
                cull = Direction.field_11033; // can never remember
            }
