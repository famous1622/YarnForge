...
public class BlockInfo
{
    ...
    public void updateLightMatrix()
    {
        ...
        for(Direction side : SIDES)
        {
            ...
            BlockState thisStateShape = this.state.isOpaque() && this.state.hasSidedTransparency() ? this.state : Blocks.field_10124.getDefaultState();
            BlockState otherStateShape = state.isOpaque() && state.hasSidedTransparency() ? state : Blocks.field_10124.getDefaultState();
