...
public class ExistingFileHelper {
    ...
    public ExistingFileHelper(Collection<Path> existingPacks, boolean enable) {
        this.clientResources = new ReloadableResourceManagerImpl(ResourceType.field_14188, Thread.currentThread());
        this.serverData = new ReloadableResourceManagerImpl(ResourceType.field_14190, Thread.currentThread());
    ...
    private ResourceManager getManager(ResourceType type) {
        return type == ResourceType.field_14188 ? clientResources : serverData;
    }
