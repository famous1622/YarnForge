    ...
    public static class ExistingModelFile extends ModelFile {
        ...
        protected boolean exists() {
            if (getUncheckedLocation().getPath().contains("."))
                return existingHelper.exists(getUncheckedLocation(), ResourceType.field_14188, "", "models");
            else
                return existingHelper.exists(getUncheckedLocation(), ResourceType.field_14188, ".json", "models");
        }
    }
}
