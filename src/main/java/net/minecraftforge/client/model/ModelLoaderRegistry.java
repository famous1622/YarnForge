...
public class ModelLoaderRegistry
{
    ...
    public static Optional<ModelBakeSettings> deserializeTransform(JsonDeserializationContext context, JsonElement transformData)
    {
        ...
        else
        {
            ...
            deserializeTRSR(context, transforms, transform, "thirdperson", ModelTransformation.Mode.field_4320);
            deserializeTRSR(context, transforms, transform, "thirdperson_righthand", ModelTransformation.Mode.field_4320);
            deserializeTRSR(context, transforms, transform, "thirdperson_lefthand", ModelTransformation.Mode.field_4323);

            deserializeTRSR(context, transforms, transform, "firstperson", ModelTransformation.Mode.field_4322);
            deserializeTRSR(context, transforms, transform, "firstperson_righthand", ModelTransformation.Mode.field_4322);
            deserializeTRSR(context, transforms, transform, "firstperson_lefthand", ModelTransformation.Mode.field_4321);

            deserializeTRSR(context, transforms, transform, "head", ModelTransformation.Mode.field_4316);
            deserializeTRSR(context, transforms, transform, "gui", ModelTransformation.Mode.field_4317);
            deserializeTRSR(context, transforms, transform, "ground", ModelTransformation.Mode.field_4318);
            deserializeTRSR(context, transforms, transform, "fixed", ModelTransformation.Mode.field_4319);
