...
public class ForgeIngameGui extends InGameHud
{
    ...
    public void render(float partialTicks)
    {
        ...
        if (renderPortal && !client.player.hasStatusEffect(StatusEffects.field_5916))
        {
    ...
    private void renderHelmet(float partialTicks)
    {
        ...
        if (this.client.options.perspective == 0 && !itemstack.isEmpty())
        {
            ...
            if (item == Blocks.field_10147.asItem())
            {
    ...
    protected void renderHotbar(float partialTicks)
    {
        ...
        if (client.interactionManager.getCurrentGameMode() == GameMode.field_9219)
        {
    ...
    protected void renderAir(int width, int height)
    {
        ...
        if (player.isInFluid(FluidTags.field_15517) || air < 300)
        {
    ...
    public void renderHealth(int width, int height)
    {
        ...
        int regen = -1;
        if (player.hasStatusEffect(StatusEffects.field_5924))
        {
            regen = ticks % 25;
        }
        ...
        int MARGIN = 16;
        if (player.hasStatusEffect(StatusEffects.field_5899))      MARGIN += 36;
        else if (player.hasStatusEffect(StatusEffects.field_5920)) MARGIN += 72;
    ...
    public void renderFood(int width, int height)
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            if (client.player.hasStatusEffect(StatusEffects.field_5903))
            {
                icon += 36;
                background = 13;
            }
