...
public class CapabilityFluidHandler
{
    ...
    public static void register()
    {
        ...
        CapabilityManager.INSTANCE.register(IFluidHandlerItem.class, new DefaultFluidHandlerStorage<>(), () -> new FluidHandlerItemStack(new ItemStack(Items.field_8550), FluidAttributes.BUCKET_VOLUME));
    }
