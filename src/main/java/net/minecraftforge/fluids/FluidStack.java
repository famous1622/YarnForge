...
public class FluidStack
{
    ...
    public static final FluidStack EMPTY = new FluidStack(Fluids.field_15906, 0);
    ...
    public static FluidStack readFromPacket(PacketByteBuf buf)
    {
        ...
        if (fluid == Fluids.field_15906) return EMPTY;
        return new FluidStack(fluid, amount, tag);
    }

    public final Fluid getFluid()
    {
        return isEmpty ? Fluids.field_15906 : fluidDelegate.get();
    }
    ...
    protected void updateEmpty() {
        isEmpty = getRawFluid() == Fluids.field_15906 || amount <= 0;
    }
    ...
    {
        if (getRawFluid() == Fluids.field_15906) throw new IllegalStateException("Can't modify the empty stack.");
        this.amount = amount;
        updateEmpty();
    }
