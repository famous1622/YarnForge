...
public class FluidUtil
{
                    ...
                    if (!simulatedTransfer.isEmpty())
                    {
                        if (doFill)
                        {
                            ...
                            if (player != null)
                            {
                                ...
                                player.world.playSound(null, player.getX(), player.getY() + 0.5, player.getZ(), soundevent, SoundCategory.field_15245, 1.0F, 1.0F);
                            }
                        }
                        else
                        {
    ...
    public static boolean tryPlaceFluid(@Nullable PlayerEntity player, World world, Hand hand, BlockPos pos, IFluidHandler fluidSource, FluidStack resource)
    {
        ...
        ItemPlacementContext context = new ItemPlacementContext(new ItemUsageContext(player, hand, new BlockHitResult(Vec3d.ZERO, Direction.field_11036, pos, false))); //TODO: This neds proper context...
    ...
    public static ItemStack getFilledBucket(@Nonnull FluidStack fluidStack)
    {
        ...
        if (!fluidStack.hasTag() || fluidStack.getTag().isEmpty())
        {
            ...
            {
                return new ItemStack(Items.field_8103);
            }
        }
