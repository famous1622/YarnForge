...
public class ForgeEventFactory
{
    ...
    {
        Result result = canEntitySpawn(entity, world, x, y, z, spawner, SpawnType.field_16469);
        if (result == Result.DEFAULT)
            return entity.canSpawn(world, SpawnType.field_16469) && entity.canSpawn(world); // vanilla logic (inverted)
        else
    ...
    {
        return renderBlockOverlay(player, mat, OverlayType.FIRE, Blocks.field_10036.getDefaultState(), new BlockPos(player));
    }

    @OnlyIn(Dist.CLIENT)
    public static boolean renderWaterOverlay(PlayerEntity player, MatrixStack mat)
    {
        return renderBlockOverlay(player, mat, OverlayType.WATER, Blocks.field_10382.getDefaultState(), new BlockPos(player));
    }
    ...
    public static boolean getMobGriefingEvent(World world, Entity entity)
    {
        ...
        return result == Result.DEFAULT ? world.getGameRules().getBoolean(GameRules.field_19388) : result == Result.ALLOW;
    }
