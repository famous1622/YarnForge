...
public class BlockEvent extends Event
{
    ...
    public static class BreakEvent extends BlockEvent
    {
        ...
        public BreakEvent(World world, BlockPos pos, BlockState state, PlayerEntity player)
        {
            ...
            {
                int bonusLevel = EnchantmentHelper.getLevel(Enchantments.field_9130, player.getMainHandStack());
                int silklevel = EnchantmentHelper.getLevel(Enchantments.field_9099, player.getMainHandStack());
