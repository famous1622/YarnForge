...
public interface IForgeWorldType
{
            ...
            OverworldChunkGeneratorConfig chunkSettings, LongFunction<C> contextFactory)
    {
        ...
        parentLayer = AddBambooJungleLayer.field_16120.create(contextFactory.apply(1001L), parentLayer);
        parentLayer = BiomeLayers.stack(1000L, ScaleLayer.field_16196, parentLayer, 2, contextFactory);
        parentLayer = EaseBiomeEdgeLayer.field_16091.create(contextFactory.apply(1000L), parentLayer);
        return parentLayer;
    }
}
