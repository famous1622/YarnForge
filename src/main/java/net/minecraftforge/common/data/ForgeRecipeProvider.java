...
public class ForgeRecipeProvider extends RecipesProvider
{
    ...
    {
        replace(Items.field_8600,        Tags.Items.RODS_WOODEN);
        replace(Items.field_8695,   Tags.Items.INGOTS_GOLD);
        replace(Items.field_8620,   Tags.Items.INGOTS_IRON);
        replace(Items.field_8477,      Tags.Items.GEMS_DIAMOND);
        replace(Items.field_8687,      Tags.Items.GEMS_EMERALD);
        replace(Items.CHEST,        Tags.Items.CHESTS_WOODEN);
        replace(Blocks.field_10445, Tags.Items.COBBLESTONE);

        exclude(Blocks.field_10205);
        exclude(Items.field_8397);
        exclude(Blocks.field_10085);
        exclude(Items.field_8675);
        exclude(Blocks.field_10201);
        exclude(Blocks.field_10234);
        
        exclude(Blocks.field_10596);
        exclude(Blocks.field_10351);
        exclude(Blocks.field_10625);
