...
public class CustomPlantTypeTest
{
    ...
    public static class CustomPlantBlock extends FlowerBlock implements IPlantable
    {
        ...
        {
            super(StatusEffects.field_5911, 9, Block.Settings.of(Material.PLANT).noCollision().sounds(BlockSoundGroup.GRASS));
        ...
        public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos)
        {
            ...
            return soil.canSustainPlant(world, pos, Direction.field_11036, this);
        }
